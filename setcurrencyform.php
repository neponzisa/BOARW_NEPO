...
-->
 ...
 <form class="modal-content animate" action="insertdata.php" method="post">
    ...
    <div class="container">
	<h2>Add New Exchange Rate In Currency Form</h2>
		 ...
		 <input type="radio" value="Buying" required="required" name="action" > Buying
         <input type="radio" value="Selling" required="required"   name="action" >Selling
		 </font>
		 </p>  
	<hr / color="green">
		<table border="0">	
		...
		<tr><td>
			...
			<div class="container" style="background-color:#f1f1ff;">
				<button type="submit" name="save_data">Save Sell Rate</button>
