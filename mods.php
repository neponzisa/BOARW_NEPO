...
$query="select * from sell where sID= $sID";
...
?>
 <form class="modal-content animate" action="modsells.php" method="POST">
    ...
    <div class="container">
	<h2>Modify Sells Exchange Rate In this Currency Form</h2>
		 ...
		 <!--<input type="radio" value="<?php// echo $action; ?>"  name="action" > Buying-->
